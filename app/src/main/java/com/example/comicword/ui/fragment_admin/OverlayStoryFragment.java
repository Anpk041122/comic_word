    ...
    public void setActionAddStory(View view){
        ...
        buttonAddStory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String titleStory = etTitleStory.getText().toString();
                String authorStory = etAuthorStory.getText().toString();
                String descriptionStory = etDescriptionStory.getText().toString();
                String etTypeStory = spinerTypeStory.
